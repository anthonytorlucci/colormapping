...
bamako_cmdata = [[0.0011753, 0.25004, 0.3],      
...
# bamako_cmap = LinearSegmentedColormap.from_list('bamako', bamako_cmdata)

mappy_rgb = numpy.array(bamako_cmdata)
mappy_name = 'scientific colormaps 7 - bamako'
