...
berlin_cmdata = [[0.62108, 0.69018, 0.99951],      
...
# berlin_cmap = LinearSegmentedColormap.from_list('berlin', berlin_cmdata)

mappy_rgb = numpy.array(berlin_cmdata)
mappy_name = 'scientific colormaps 7 - berlin'
