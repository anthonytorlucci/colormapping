...
broc_cmdata = [[0.17081, 0.10027, 0.29985],      
...
# broc_cmap = LinearSegmentedColormap.from_list('broc', broc_cmdata)

mappy_rgb = numpy.array(broc_cmdata)
mappy_name = 'scientific colormaps 7 - broc'
