...
# roma_cmap = LinearSegmentedColormap.from_list('roma', roma_cmdata)

mappy_rgb = numpy.array(roma_cmdata)
mappy_name = 'scientific colormaps 7 - roma'
