...
turku_cmdata = [
    [6.3216e-05, 5.1671e-06, 3.583e-05],      
    ...
    [1, 0.89746, 0.89609],      
    [1, 0.90174, 0.90067]]            
# turku_cmap = LinearSegmentedColormap.from_list('turku', turku_cmdata)

mappy_rgb = numpy.array(turku_cmdata)
mappy_name = 'scientific colormaps 7 - turku'
